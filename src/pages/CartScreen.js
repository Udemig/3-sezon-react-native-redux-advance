...
const styles = StyleSheet.create({
  ...
  buttonContainer: {position: 'absolute', top: 110, right: 10},
  button: {borderRadius: 8, backgroundColor: '#ff333390', padding: 5},
  buttonEmpty: {borderRadius: 8, backgroundColor: 'blue', padding: 10},
